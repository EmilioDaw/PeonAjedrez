...
public class PeonTest {
	...
	private static final String COLOR_NO_NULO = "DeberÃ­a haber saltado una excepciÃ³n indicando que el color no puede ser nulo.";
	private static final String DIRECCION_NO_NULA = "DeberÃ­a haber saltado una excepciÃ³n indicando que no se puede mover en una direcciÃ³n nula.";
	...
	private static final String ERROR_DOS_PASOS = "ERROR: El peón solo se puede mover 2 pasos cuando se encuentra en la casilla inicial.";
	private static final String ERROR_NUMERO_PASOS = "ERROR: El peón solo se puede mover 1 o 2 pasos.";
